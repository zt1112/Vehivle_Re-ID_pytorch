...
def main():
    ...
    #data_transforms1 = transforms.Compose([train_aug])
    data_transforms1 = transforms.Compose([
        #transforms.RandomRotation(cfg.CLS.rotation),
        #RandomPixelJitter(cfg.CLS.pixel_jitter),
    ...
    train_datasets = CustomData(img_path=root,
                                txt_path=('/home/priv-lab1/Database/vehicleid/wzh_list_2/train_13164.txt'),
                                data_transforms=data_transforms1)
    val_datasets = CustomData(img_path=root,
                                txt_path=('/home/priv-lab1/Database/vehicleid/wzh_list_2/val_13164.txt'),
                                data_transforms=data_transforms2)
